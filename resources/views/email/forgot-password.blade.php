...
<table id="u_content_heading_1" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h1 style="margin: 0px; color: #000000; line-height: 140%; text-align: center; word-wrap: break-word; font-family: tahoma,arial,helvetica,sans-serif; font-size: 26px; "><strong>Lupa Kata Sandi</strong></h1>
...
<table id="u_content_text_2" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-family: tahoma,arial,helvetica,sans-serif; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="line-height: 140%;">Berikut ini adalah kata sandi baru anda:</p>
    <p>{{ $password }}</p>
  </div>
